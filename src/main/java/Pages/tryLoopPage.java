...
public class tryLoopPage extends baseTest {
	...
	public String get_table_valuess() {
		...
		int rowcount = driver.findElements(By.xpath("//table[@class='MuiTable-root css-15i8i05-MuiTable-root']//tr"))
				.size();
		// int colcount=driver.findElements(By.xpath("//table[@class='MuiTable-root
		// css-15i8i05-MuiTable-root']//th")).size();
		...
		for (int i = 1; i < rowcount; i++) {
			...
			for (int j = 1; j <= colcount; j++) {
				...
				String text = driver.findElement(By.xpath(
						"//table[@class='MuiTable-root css-15i8i05-MuiTable-root']//tbody/tr[" + i + "]/td[" + j + "]"))
						.getText();
	...
	public static void fetchtada(String value) throws IOException {
		...
		br = new BufferedReader(
				new FileReader(System.getProperty("user.dir") + "\\DownloadFolder\\chargebacks_payouts_overview.csv"));
